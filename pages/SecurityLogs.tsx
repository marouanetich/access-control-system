                            ...
                            filteredLogs.map(log => (
                                <React.Fragment key={log.id}>
                                    ...
                                    >
                                        ...
                                        <td className="p-3">
                                            <span className={`px-2 py-0.5 rounded text-[10px] font-bold border ${log.eventType.includes('ATTACK') || log.eventType.includes('FAILURE') || log.eventType.includes('LOCKOUT') ? 'bg-red-900/20 border-red-500/20 text-red-500' :
